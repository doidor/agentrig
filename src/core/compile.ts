...
import { populateAgentsMarkers, type MarkerUpdateResult } from "./markers.js";
...
export interface CompileResult {
  ...
  /** Result of refreshing the deterministic `<!-- AGENTRIG:*:start/end -->` blocks in AGENTS.md. */
  markers: MarkerUpdateResult;
}
...
export function compileSurfaces(repoRoot: string): CompileResult {
  // Refresh the auto-populated marker blocks in AGENTS.md FIRST so the projections downstream
  // (copilot-instructions.md, CLAUDE.md, …) all inherit the up-to-date skills inventory etc.
  const markers = populateAgentsMarkers(repoRoot);
  const result: CompileResult = { generated: [], skipped: [], markers };
